...
\begin{figure}[H]
    ...
    \caption[SCC, NRMSE and MRD on RNA sequins in SG-NEx data]{SCC, NRMSE and MRD on sequencing spike-ins in SG-NEx data. \textbf{a.} SCC for each of the three methods across four samples. \textbf{b.} NRMSE for each of the three methods across four samples. \textbf{c.} MRD for each of the three methods across four samples.}
...
\begin{figure}[H]
    ...
    \caption[Scatter plots on RNA sequins in SG-NEx data]{Scatter plots on RNA sequins in sample K562 replicate 5 run 1 for Bambu, Deg. EM (emp.) and NanoCount.}
...
Results on the SIRV-4 spike-ins.