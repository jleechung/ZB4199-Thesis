...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/ll.png}
...
\end{equation}
The \textbf{reproducibility metric} (RM) is a reference-free metric that measures the variance across replicates. Let $\bar{\bm\theta}$ be the mean of estimates across $K$ replicates. For isoform $i$, the RM is given by
\begin{equation}
