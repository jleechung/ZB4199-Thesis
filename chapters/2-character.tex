...
\end{definition}
In the following sections, we describe our approach for estimating the degradation rate and measuring possible sequencing artifacts, and present findings based on ONT long-read RNA-seq data from the SG-NEx project. The data we examine comprise ONT long-read direct RNA-seq from five common cancer cell lines: A549, Hct116, HepG2, MCF7 and K562.   

\section{Degradation rate estimation}

\subsection{Stratification of isoforms}

\subsection{Coverage and read length distribution}

\section{Nanopore sequencing artifacts}
