...
\begin{figure}[H]
    ...
    \caption[Degradation curves on real datasets based on coverage]{Degradation curves on real datasets based on coverage.}
    \label{fig:cov-real}
\end{figure}
