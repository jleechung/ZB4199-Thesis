...
\end{definition}
In the following sections, we describe approaches for estimating the degradation rate and present findings based on ONT long-read RNA-seq data from common cancer cell lines (A549, Hct116, HepG2, MCF7 and K562) as part of the SG-NEx project and a human embryonic stem cell line (H9). 
